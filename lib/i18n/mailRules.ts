...
const mailRulesCopy = {
  en: {
    ...
    privacy: {
      ...
      sharing:
        "The operator does not sell, rent, or share Google user data with advertisers. Gmail-derived tool results are transmitted to OpenAI only when the owner explicitly invokes a Gmail listing, reconciliation preview, or rule test through Codex. OAuth credentials may be stored in the owner's private 1Password vault solely for backup.",
      limitedUse:
  ...
  it: {
    ...
    privacy: {
      ...
      sharing:
        "Il gestore non vende, affitta o condivide i dati utente Google con inserzionisti. I risultati degli strumenti derivati da Gmail vengono trasmessi a OpenAI solo quando il proprietario invoca esplicitamente tramite Codex un elenco Gmail, un'anteprima di riconciliazione o il test di una regola. Le credenziali OAuth possono essere conservate nel vault 1Password privato del proprietario esclusivamente come backup.",
      limitedUse:
