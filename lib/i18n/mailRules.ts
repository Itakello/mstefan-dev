  ...
  en: {
    ...
    privacy: {
      ...
      accessItems: [
        ...
        "search for matching messages and read their Gmail message identifier, sender, subject, date, short message-text snippet, thread identifier, and label identifiers for rule previews.",
      ],
      accessBoundary:
      ...
      security:
        "Credentials are excluded from version control. Gmail-changing operations are approval-gated, and destructive filter replacement is restricted to one exact, verified conflict. The owner can revoke Google access and delete the local OAuth files and private 1Password backup to remove those stored credentials. If ADC was used, the owner must also revoke or delete it through the controls for its configured source, such as Google Account or Google Cloud CLI for gcloud user credentials, or the relevant file or attached environment for other credentials.",
      deletionBoundary:
  ...
  it: {
    ...
    privacy: {
      ...
      accessItems: [
        ...
        "cercare i messaggi corrispondenti e leggere l'identificativo Gmail del messaggio, mittente, oggetto, data, un breve estratto testuale, identificativo della conversazione e identificativi delle etichette per le anteprime delle regole.",
      ],
      accessBoundary:
